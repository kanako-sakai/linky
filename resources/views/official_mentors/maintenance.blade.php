    		...
    		<div class="row justify-content-center pb-5">
            	<div class="col-md-10 heading-section">
                	<h2 class="mb-4 text-center">オフィシャルメンター</h2>
                        ...
                        <p class="maintenance-message">※現在メンテナンスのため、リクエストの受付を一時停止しております。</r>
                        メンテナンスが終わり次第、リクエストの受付を再開させていただきますので暫しお待ちください。<br>
                        ご不便をおかけしてしまい大変申し訳ございません。他のサービスは引き続きご利用頂けますのでご利用ください。</p>
