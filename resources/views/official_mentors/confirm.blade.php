                            ...
                            <div class="panel-body">
                                ...
                                <div class="bg-light card-body">
                                    <form method="POST" action="{{ route('official.complete', $user->id) }}">
                                        ...
                                        <div class="form-group row">
                                            <label for="name" class="col-md-4 col-form-label text-md-right">【ご希望プラン】</label>
                                            <div class="col-md-6">
                                                <span class="">{{$official_request->plan}}</span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <span class="">{{$official_request->mentor_pref}}</span>
                                                <input type="hidden" name="mentor_pref" value="{{$official_request->mentor_pref}}">
                                            </div>
                                        </div>
