<ul class="list-group list-group-horizontal">
    ...
    <li class="list-group-item text-center">
        ...
        <span class="badge-parent"><span class="badge badge-secondary badge-pill btn-left mt-1">{{ $user->mentor_requestings_count }}</span></span>
        </a>
    </li>
    {{-- リクエスト依頼一覧タブ --}}
    <li class="list-group-item text-center">
        ...
        <span class="badge badge-secondary badge-pill btn-left mt-1">{{ $user->requesters_count }}</span>
        </a>
    </li>
    {{-- マッチング成立一覧タブ --}}
    <li class="list-group-item text-center">
        ...
        <span class="badge badge-secondary badge-pill btn-left mt-1">{{ $user->mentor_requests_count }}</span>    
