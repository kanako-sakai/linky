...
<section class="ftco-section" id="coaches-section">
    	<div class="container mt-4 mb-4">
    	    <div class="border p-4">
                ...
                <form method="POST" action="{{ route('blog.update', $article->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <fieldset class="mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content" class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" rows="4">{{ old('content') ?: $article->content }}</textarea>
                        ...
                        <div class="mt-5">
                            <a class="btn btn-light" href="{{ route('blog.show', $article->id) }}">
                                キャンセル
                            </a>
