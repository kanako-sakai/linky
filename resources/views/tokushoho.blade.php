                        ...
                        <table class="profile table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <p>クレジットカード</p>
                                    <p>【お支払時期】</p>
                                    <p>公式メンター相談のチケットをご購入される段階でのお支払いとなります。複数回分のチケットをご購入される場合においても、全回分前払いとなります。</p>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-left">提供時期・提供方法</th>
                                    <td class="text-left"><p>ご購入後、直ちにリクエストフォームをご提出いただけます。</p>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">有効期限は、チケットのご購入した月を1ヵ月目と起算し、6カ月目の末日までとなります。</td>
                                </tr>
                                <tr>
