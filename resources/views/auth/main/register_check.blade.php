    	...
    	<div class="container">
            ...
            <div class="card-body">
                ...
                {!! Form::hidden('email_verify_token', $email_verify_token); !!}
                    ...
                    <div class="form-group row">
                        <label for="working_years" class="col-md-4 col-form-label text-md-right">【社会人歴】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="education" class="col-md-4 col-form-label text-md-right">【最終学歴】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="employee" class="col-md-4 col-form-label text-md-right">【ご勤務先】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="industry_id" class="col-md-4 col-form-label text-md-right">【業種】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="job_category_id" class="col-md-4 col-form-label text-md-right">【職種】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="oversea_exp" class="col-md-4 col-form-label text-md-right">【海外経験】</label>
                        <div class="col-md-6">
                            <span class="">
                                @if ($profile->expat == 0)
                                    <p></p>
                    ...
                    <div class="form-group row">
                        <label for="job_category_id" class="col-md-4 col-form-label text-md-right">【転職経験】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="marriage_status" class="col-md-4 col-form-label text-md-right">【既婚／未婚】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="child_status" class="col-md-4 col-form-label text-md-right">【お子様の有無】</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="intro" class="col-md-4 col-form-label text-md-right">【自己紹介文】</label>
                        <div class="col-md-6">
